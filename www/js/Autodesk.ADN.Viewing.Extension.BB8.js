...
Autodesk.ADN.Viewing.Extension.BB8 = function (viewer, options) {
  ...
  var BB8API = {
    ...
    connect: function(uuid) {
      ...
      var url = options.cylonApiUrl + '/connect/' +
        uuid;
    ...
    setColor: function(uuid, color) {
      ...
      var url = options.cylonApiUrl + '/color/' +
        uuid + '/' +
        color;
    ...
    setHeading: function(uuid, heading) {

      var url = options.cylonApiUrl + '/heading/' +
        uuid + '/' +
        heading;
    ...
    roll: function(uuid, speed, heading) {

      var url = options.cylonApiUrl + '/roll/' +
        uuid + '/' +
        speed + '/' +
        heading;
  ...
  //name: BB-432F
  //UUID: 5d0f662abd3c48a8a5142de32e9bd6f5
  //UUID: 7d7e545da568419a87975b1218064823

  var _deviceUUID = '7d7e545da568419a87975b1218064823';
  ...
  this.load = function () {
    ...
    BB8API.connect(_deviceUUID).then(
      function() {
  ...
  var Panel = function(
    ...
    function createControls() {
      ...
      joystick.addEventListener('deactivate', function() {
        ...
        setTimeout(function() {
          BB8API.roll(_deviceUUID, 0, 0)
        }, 300);
      });

      $('#heading-range-' + id).change(function(){

        BB8API.setHeading(_deviceUUID, this.value);
      });
  ...
  var css = [
    ...
    'form.bb8-panel-controls{',
      'margin: 20px;',
    '}',

    'input.bb8-panel-name {',
      'height: 30px;',
      'margin-left: 5px;',
      'margin-bottom: 5px;',
      'margin-top: 5px;',
